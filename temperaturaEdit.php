...
<head>
    ...
    <title>Editar Temperatura</title>
</head>
	        ...
	        <div class="columna col-4">
	        	<form method="POST" action="">
					<div class="row form-group">
						...
						<hr class="bg-info">
						<p class="pb-0 mb-0">La Unidad de Medida esta en &#176 C</p>
						...
						<input type="submit" name="editarTemp" value="Editar" class="btn btn-success">
					</div>
				</form>
	        </div>
	        <?php 
				...
				if (isset($_POST['editarTemp'])) {
					$editarTemp = $_POST['tempN'];
					$editarId = 1;

					$editar_sql = "UPDATE temperaturabase SET temp='$editarTemp' WHERE id= '$editarId'";

					$ejecutar = mysqli_query($conn, $editar_sql);

					if ($ejecutar) {
						echo "<script>alert('Temperatura Editada')</script>";
